...
vim.cmd'noremenu <silent> PopUp.Save <C-u>:w<CR>'
vim.cmd'noremenu <silent> PopUp.Quit <C-u>:q<CR>'
-- vim.cmd'noremenu <silent> PopUp.Force\\ Quit <C-u>:q!<CR>'
...
vim.cmd'nnoremenu <silent> PopUp.Toggle\\ Scrollbar :ScrollbarToggle<CR>'
vim.cmd'inoremenu <silent> PopUp.Toggle\\ Scrollbar <C-o>:ScrollbarToggle<CR>'
...
vim.cmd'nnoremenu <silent> PopUp.Launch\\ REPL :call ToggleTerm()<CR>'
vim.cmd'inoremenu <silent> PopUp.Launch\\ REPL <C-o>:call ToggleTerm()<CR>'
