...
HOME = os.getenv("HOME")
vim.api.nvim_create_user_command("MyScripts", ":Telescope find_files cwd=" .. HOME .. "/.scripts", {nargs=0})
...
vim.api.nvim_set_keymap("n", "<leader>fs", ":MyScripts<CR>", {silent=true, noremap=true, desc="Telescope on personal scripts"})
