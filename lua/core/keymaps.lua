...
vim.api.nvim_set_keymap("n", "<leader>ev", ":edit $MYVIMRC<CR>", {silent=true, desc="Edit init file", noremap=true})
...
vim.api.nvim_set_keymap("t", "<M-H>", "<C-\\><C-n>gT", {silent=true, noremap=true})
vim.api.nvim_set_keymap("t", "<M-L>", "<C-\\><C-n>gt", {silent=true, noremap=true})
vim.api.nvim_set_keymap("n", "-", "za", {silent=true, noremap=true, desc="Toggle folding"})
vim.api.nvim_set_keymap("n", "<leader>-", "zA", {silent=true, noremap=true, desc="Toggle folding"})
...
vim.api.nvim_set_keymap("n", "<leader>to", ":TODO<CR>", {silent=true, desc="Open TODO"})
vim.api.nvim_set_keymap("n", "<leader><leader>", ":NNN<CR>", {silent=true, desc="Open NNN"})
...
vim.api.nvim_set_keymap("n", "[g", ":Gitsigns prev_hunk<CR>", {silent=true, noremap=true, desc="Jump to previous hunk"})
vim.api.nvim_set_keymap("n", "]g", ":Gitsigns next_hunk<CR>", {silent=true, noremap=true, desc="Jump to next hunk"})
...
vim.api.nvim_set_keymap("n", "<leader>gq", ":Gitsigns setqflist<CR>", {silent=true, noremap=true, desc="Show hunks in quickfix"})
