...
vim.cmd [[au FileType r ++once lua require("packer.load")({'nvim-lspconfig'}, { ft = "r" }, _G.packer_plugins)]]
vim.cmd [[au FileType rmd ++once lua require("packer.load")({'nvim-lspconfig'}, { ft = "rmd" }, _G.packer_plugins)]]
