...
local mappings = function(client, bufnr)
    ...
    buf_set_keymap('n', '[W', '<cmd>lua vim.diagnostic.goto_prev({severity = vim.diagnostic.severity.ERR})<CR>', opts)
    buf_set_keymap('n', ']W', '<cmd>lua vim.diagnostic.goto_next({severity = vim.diagnostic.severity.ERR})<CR>', opts)
